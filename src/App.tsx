...
import { Menu, X, Dumbbell, MessageCircle, Mail, Phone, Star, ChevronDown } from 'lucide-react';
...
function App() {
  ...
  return (
    <div className="min-h-screen bg-black text-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center gap-2">
              ...
              <span className="text-2xl font-bold text-yellow-500">CW Life</span>
            </div>

            <div className="hidden md:flex gap-8">
              {['Inicio', 'Sobre Mí', 'Programas', 'Precios', 'Contacto'].map((item) => (
                <button
                  key={item}
      ...
      <section id="inicio" className="relative pt-24 pb-20 px-4 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6 animate-fade-in">
              ...
              <p className="text-xl text-gray-400">
                Coaching personalizado que te lleva desde donde estás hasta donde quieres estar. Sin excusas, con resultados reales.
              </p>
              ...
              <div className="absolute -bottom-6 -left-6 bg-black border-2 border-yellow-500 rounded-xl p-4 shadow-xl">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-400">Clientes Transformados</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="grid md:grid-cols-3 gap-6 mt-20">
            {[
              { title: 'Plan a Medida', desc: 'Entrenamiento personalizado según tus objetivos' },
              { title: 'Seguimiento 24/7', desc: 'Acompañamiento constante en tu proceso' },
              { title: 'Resultados Garantizados', desc: 'Compromiso total con tu transformación' }
            ].map((feature, i) => (
              <div
                key={i}
      ...
      <section id="sobre-mí" className="py-20 px-4 bg-gradient-to-b from-black to-yellow-500/5">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              ...
              <p className="text-lg text-gray-300 leading-relaxed">
                Hace años, yo también estuve en tu lugar. Perdido, sin dirección, sin saber cómo alcanzar mis metas.
                Hoy soy entrenador personal certificado y he ayudado a más de 500 personas a transformar sus vidas.
              </p>
              <p className="text-lg text-gray-300 leading-relaxed">
                Mi misión es simple: guiarte paso a paso en tu transformación, con un plan personalizado,
                seguimiento constante y el apoyo que necesitas para lograr resultados reales y duraderos.
              </p>
              <div className="flex gap-4">
                <a href="https://instagram.com" className="text-yellow-500 hover:text-yellow-400 transition-colors">
                  Instagram
                </a>
                <a href="https://facebook.com" className="text-yellow-500 hover:text-yellow-400 transition-colors">
                  Facebook
                </a>
                <a href="mailto:contact@cwlife.com" className="text-yellow-500 hover:text-yellow-400 transition-colors">
                  Email
                </a>
              </div>
            </div>
      ...
      <section id="programas" className="py-20 px-4 bg-black">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-400">Elige la modalidad que mejor se adapte a ti</p>
          </div>
            ...
            {[
              {
                ...
                features: ['Plan personalizado', 'Videos demostrativos', 'Seguimiento semanal', 'Chat directo']
              },
              {
                title: 'Presencial',
                desc: 'Sesiones individuales en Buenos Aires para maximizar tu rendimiento con atención 100% dedicada.',
                features: ['Atención personalizada', 'Buenos Aires', 'Equipamiento completo', 'Resultados más rápidos']
              },
              {
                title: 'Reconstruirte',
                desc: 'Programa especializado de recuperación post-lesión para volver más fuerte que antes.',
                features: ['Post-lesión', 'Plan adaptado', 'Fisioterapia integrada', 'Vuelta segura']
              }
            ].map((program, i) => (
              <div
                key={i}
              ...
              >
                <h3 className="text-2xl font-bold text-yellow-500 mb-4">{program.title}</h3>
      ...
      <section className="py-20 px-4 bg-gradient-to-b from-black to-yellow-500/5">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {[
              { name: 'Juan P.', result: '-15kg en 3 meses', review: 'Increíble el cambio, tanto físico como mental. Cristian me ayudó a crear hábitos que ahora son parte de mi vida.' },
              { name: 'María G.', result: 'Ganó 8kg músculo', review: 'Nunca pensé que podría lograr este nivel de fuerza y definición. El seguimiento es impecable.' },
              { name: 'Lucas R.', result: 'Recuperación total', review: 'Después de mi lesión pensé que no volvería a entrenar. El programa Reconstruirte me devolvió la confianza.' }
            ].map((testimonial, i) => (
              <div
                key={i}
              ...
              >
                ...
                <div className="pt-4 border-t border-yellow-500/20">
                  <div className="font-bold text-yellow-500">{testimonial.name}</div>
                  <div className="text-sm text-gray-400">{testimonial.result}</div>
                </div>
              </div>
            ))}
          </div>
      ...
      <section id="precios" className="py-20 px-4 bg-black">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold mb-4">
              Planes de <span className="text-yellow-500">Inversión</span>
            </h2>
            <p className="text-xl text-gray-400">Elige el compromiso que se ajuste a tus objetivos</p>
          </div>

          <div className="grid md:grid-cols-3 gap-8">
            {[
              { months: '1 Mes', price: '$120.000', features: ['Plan personalizado', 'Seguimiento semanal', 'Chat directo', 'Videos técnica'], recommended: false },
              { months: '2 Meses', price: '$260.000', features: ['Todo lo anterior', 'Ajustes quincenales', 'Plan nutrición básico', 'Soporte prioritario'], recommended: true },
              { months: '3 Meses', price: '$360.000', features: ['Todo lo anterior', 'Plan nutrición completo', 'Seguimiento diario', 'Garantía resultados'], recommended: false }
            ].map((plan, i) => (
              <div
                key={i}
                className={`relative p-8 rounded-2xl transition-all transform hover:-translate-y-2 ${
                  plan.recommended
                    ? 'bg-gradient-to-br from-yellow-500/20 to-yellow-500/5 border-2 border-yellow-500 scale-105'
                    : 'bg-gradient-to-br from-yellow-500/5 to-transparent border-2 border-yellow-500/20 hover:border-yellow-500/50'
                }`}
              >
                {plan.recommended && (
                ...
                <div className="text-center mb-6">
                  <div className="text-yellow-500 font-bold text-lg mb-2">{plan.months}</div>
                  <div className="text-4xl font-bold mb-2">{plan.price}</div>
                  <div className="text-gray-400 text-sm">ARS por mes</div>
                </div>
                ...
                <a
                  ...
                  className={`block w-full py-4 rounded-lg text-center font-bold transition-all ${
                    plan.recommended
                      ...
                      : 'bg-yellow-500/10 text-yellow-500 border border-yellow-500 hover:bg-yellow-500 hover:text-black'
                  }`}
                >
                  Comenzar Ahora
                </a>
      ...
      <section className="py-20 px-4 bg-gradient-to-b from-black to-yellow-500/5">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="space-y-4">
            {[
              { q: '¿El plan es realmente personalizado?', a: 'Sí, cada plan se diseña específicamente según tus objetivos, nivel actual, disponibilidad de tiempo y equipamiento. No hay dos planes iguales.' },
              { q: '¿Cómo funciona el seguimiento?', a: 'Recibes un plan semanal que vas ejecutando. Me envías videos de tus ejercicios y te doy feedback. Tenemos comunicación constante por WhatsApp para resolver dudas.' },
              { q: '¿Necesito equipamiento especial?', a: 'Depende de tu modalidad. Para online, adaptamos el plan a lo que tengas disponible (incluso si entrenas en casa sin equipamiento). Para presencial, mi gimnasio tiene todo lo necesario.' },
              { q: '¿Incluye plan de nutrición?', a: 'Los planes de 2 y 3 meses incluyen guías nutricionales. El plan de 3 meses incluye un plan nutricional completo y personalizado.' },
              { q: '¿Puedo entrenar desde cualquier lugar?', a: 'Absolutamente. El coaching online está diseñado para que puedas entrenar desde donde estés, ya sea en casa, en un gimnasio o viajando.' }
            ].map((faq, i) => (
              <div
                key={i}
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-12">
            ...
            >
              ...
              <div className="text-sm text-gray-400">+54 123 456 7890</div>
            </a>
          </div>
          ...
          <div className="p-8 bg-gradient-to-r from-yellow-500/20 via-yellow-500/10 to-yellow-500/20 border-2 border-yellow-500/30 rounded-2xl">
            <p className="text-lg text-gray-300">
              <span className="text-yellow-500 font-bold">Respuesta en menos de 24 horas.</span> Estoy comprometido con tu éxito desde el primer contacto.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-3 gap-8 mb-8">
            ...
            <div>
              ...
              <div className="space-y-2">
                <a href="https://instagram.com" className="block text-gray-400 hover:text-yellow-500 transition-colors">
                  Instagram
                </a>
                <a href="https://facebook.com" className="block text-gray-400 hover:text-yellow-500 transition-colors">
                  Facebook
                </a>
                <a href="https://youtube.com" className="block text-gray-400 hover:text-yellow-500 transition-colors">
                  YouTube
                </a>
              </div>
            </div>
