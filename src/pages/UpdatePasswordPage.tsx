...
export default function UpdatePasswordPage() {
    ...
    return (
        <div className="min-h-screen bg-black text-white flex flex-col items-center justify-center p-4">
            ...
            <div className="w-full max-w-md glass-card border-white/5 rounded-3xl p-10 shadow-2xl relative overflow-hidden box-glow-red">
                <div className="absolute top-0 right-0 w-32 h-32 bg-red-600/5 blur-3xl rounded-full"></div>

                <div className="text-center mb-10 relative z-10">
                    <h2 className="text-3xl font-black mb-3 uppercase tracking-tighter italic">NUEVA <span className="text-red-600">CLAVE</span></h2>
                ...
                <form onSubmit={handleUpdatePassword} className="space-y-8 relative z-10">
                    <div className="space-y-2">
                        <label className="text-[10px] font-black text-red-600/80 uppercase tracking-widest ml-1">Nueva Contraseña</label>
                        <div className="relative group">
                            <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none transition-all group-focus-within:text-red-600">
