            ...
            <div className="max-w-6xl mx-auto relative z-10">
                <div className="text-center mb-16 relative">
                    ...
                    <h1 className="text-5xl md:text-8xl font-black text-white mb-6 uppercase tracking-tighter relative z-10 italic">
                        BLACK <span className="text-white text-glow-white">TRAINING</span>
                    </h1>
                        ...
                        <div className="flex justify-center mb-16 animate-fade-in">
                            <div className="relative group">
                                ...
                                <img
                                    ...
                                    className="w-48 md:w-64 h-auto relative z-10 drop-shadow-[0_0_30px_rgba(255, 255, 255,0.2)] hover:scale-105 transition-all duration-500 filter drop-shadow-[0_0_10px_rgba(255,255,255,0.1)] group-hover:drop-shadow-[0_0_40px_rgba(255, 255, 255,0.3)]"
                                />
                            </div>
                        </div>
                    )}
